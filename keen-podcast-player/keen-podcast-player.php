...
new SPP_GitHub_Updater( __FILE__, 'edukern/simple-podcast-player', '1.0.5' );
...
function spp_missing_elementor_notice() {
    printf(
        ...
        esc_html__( 'Keen Podcast Player requires Elementor to be installed and active.', 'keen-podcast-player' )
    );
}
...
function spp_enqueue_assets() {
    ...
    wp_localize_script( 'spp-player', 'sppData', [
        'errorText' => __( 'Audio unavailable', 'keen-podcast-player' ),
    ] );
}
